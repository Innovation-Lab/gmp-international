              ...
              <ul class="p-formList">
                  ...
                  <div class="p-formList__content">
                    ...
                    <div class="p-formList__data">
                      <div class="c-input c-input--select">
                        <select onchange="changeColor(this)" name="m_brand_id" onchange="getTyArray('brand', $(this).val(), $(this).data('insert'), {{ $sales_product->id }});" data-insert="product">
                ...
                <li class="p-formList__item js-insert-list-product-{{ $sales_product->id }}">
                  <div class="p-formList__content">
                    ...
                    <div class="p-formList__data">
                      <div class="c-input c-input--select">
                        <select onchange="changeColor(this)" name="m_product_id" onchange="getTyArray('product', $(this).val(), $(this).data('insert'), {{ $sales_product->id }});" data-insert="brand" >
