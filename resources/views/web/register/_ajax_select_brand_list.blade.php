<div class="p-formList__content">
    ...
    <div class="p-formList__data">
        <div class="c-input c-input--select">
            <select name="products[{{ $loop_num }}][m_brand_id]" class="js-ty-brand" onchange="getTyArray('brand', $(this).val(), $(this).data('loop'), $(this).data('insert'));" data-loop="{{ $loop_num }}" data-insert="product">
