      ...
      <ul class="p-filterList">
        ...
        <li class="p-filterList__item">
          <div class="p-filterList__keyword">
            <input name="keyword" type="text" value="{{ request()->get('keyword') }}" placeholder="キーワードで探す">
            <button type="submit" class="c-button__search">検索する</button>
          </div>
        </li>
        {{-- 絞り込み検索 --}}
        <li class="p-filterList__item">
          <div class="c-textButton__search" data-micromodal-trigger="modal-users-fillter">絞り込み検索</div>
        </li>
      </ul>
    </div>
