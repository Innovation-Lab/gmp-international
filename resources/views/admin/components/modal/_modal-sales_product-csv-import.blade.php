<div class="modal micromodal-slide" id="modal-sales_product-import" aria-hidden="true">
  <div class="modal__overlay" tabindex="-1">
    <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
      ...
      {!! Form::open(['method' => 'post', 'route' => 'admin.csv.product.import', 'files' => true, 'id' => 'salesProductImportForm']) !!}
        <div class="c-input ">
      ...
      <footer class="modal__footer">
        ...
        <button type="submit" form="salesProductImportForm" class="modal__btn">実行する</button>
      </footer>
    </div>
  </div>
</div>
