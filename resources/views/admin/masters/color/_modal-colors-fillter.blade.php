  ...
  <div class="modal__overlay" tabindex="-1">
    <div class="modal__container lg" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
          ...
          <li class="p-formList__item">
            <div class="l-grid__1 l-grid__gap1">
              ...
              <div class="p-formList__data w-700">
                <select name="m_color_id[]" class="select2" form="colorMasterForm" multiple>
                  <option value="" >選択してください</option>
                  @foreach($select_colors as $k => $v)
      ...
      <footer class="modal__footer">
        ...
        <button form="colorMasterForm" class="modal__btn-primary">絞り込む</button>
      </footer>
    </div>
  </div>
</div>