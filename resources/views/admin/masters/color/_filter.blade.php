<form method="get" id="colorMasterForm">
  <div class="p-filter">
    <div class="p-filter__body">
      <ul class="p-filterList">
        ...
        {{-- 絞り込み検索 --}}
        <li class="p-filterList__item">
          <div class="c-textButton__search" data-micromodal-trigger="modal-colors-fillter">絞り込み検索</div>
        </li>
      </ul>
    </div>
    <div class="p-filter__action">
      <a href="{{ route('admin.masters.color') }}" class="c-button__reset">絞り込みをクリア</a>
    </div>
  </div>
</form>