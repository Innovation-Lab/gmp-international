  ...
  <div class="wrapper">
    <div class="container">
      <div class="p-detail__head__inner">
          <a href="@if(str_contains(request()->url(), 'edit')) {{ route('admin.masters.product.detail', $product) }} @else {{ $preview ?? route('admin.masters.product') }} @endif" class="c-button__2">戻る</a>
